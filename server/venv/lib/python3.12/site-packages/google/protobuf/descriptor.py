...
class _NestedDescriptorBase(DescriptorBase):
  ...
  def __init__(self, options, options_class_name, name, full_name,
    ...
    Args:
      ...
      name (str): Name of this protos message type.
      full_name (str): Fully-qualified name of this protos message type, which
        will include protos "package" name and the name of any enclosing
        types.
...
class Descriptor(_NestedDescriptorBase):
  ...
  """Descriptor for a protos message type.

  Attributes:
      name (str): Name of this protos message type.
      full_name (str): Fully-qualified name of this protos message type,
          which will include protos "package" name and the name of any
          enclosing types.
      ...
      nested_types (list[Descriptor]): Descriptor references
          for all protos message types nested within this one.
...
class FieldDescriptor(DescriptorBase):
  ...
  Attributes:
    ...
    containing_type (Descriptor): Descriptor of the protos message
...
class OneofDescriptor(DescriptorBase):
  ...
  Attributes:
    ...
    index (int): 0-based index giving the order of the oneof field inside
      its containing type.
    containing_type (Descriptor): :class:`Descriptor` of the protos message
