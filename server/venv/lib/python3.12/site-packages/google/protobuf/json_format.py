...
"""Contains routines for printing protos messages in JSON format.
...
def MessageToJson(
  ...
  Args:
    message: The protos buffers message instance to serialize.
  ...
  Returns:
    A string containing the JSON formatted protos buffer message.
  """
  printer = _Printer(
...
def MessageToDict(
  ...
  Returns:
    A dict representation of the protos buffer message.
  """
  printer = _Printer(
      preserving_proto_field_name,
      use_integers_for_enums,
...
class _Printer(object):
  """JSON format printer for protos message."""
...
def Parse(
  ...
  """Parses a JSON representation of a protos message into a message.
...
class _Parser(object):
  """JSON format parser for protos message."""
  ...
  def ConvertMessage(self, value, message, path):
    ...
    Args:
      value: A JSON object.
      message: A WKT or regular protos message to record the data.
  ...
  def _ConvertFieldValuePair(self, js, message, path):
    ...
    Args:
      ...
      message: A regular protos message to record the data.
      path: parent path to log parse error info.
  ...
  def _ConvertMapFieldValue(self, value, message, field, path):
    ...
    Args:
      ...
      message: A protos message to record the converted data.
