...
"""Contains routines for printing protos messages in text format.
...
def MessageToString(
  ...
  Args:
    message: The protos buffers message.
  ...
  Returns:
    str: A string of the text formatted protos buffer message.
  """
...
class _Printer(object):
  """Text format printer for protos message."""
...
def Parse(text,
  ...
  """Parses a text representation of a protos message into a message.
  ...
  Args:
    ...
    message (Message): A protos buffer message to merge into.
...
def ParseLines(lines,
  ...
  Args:
    ...
    message: A protos buffer message to merge into.
    allow_unknown_extension: if True, skip over missing extensions and keep
      parsing
    allow_field_number: if True, both field number and field name are allowed.
    descriptor_pool: A DescriptorPool used to resolve Any types.
...
class _Parser(object):
  """Text format parser for protos message."""
  ...
  def MergeLines(self, lines, message):
    """Merges a text representation of a protos message into a message."""
    self._allow_multiple_scalars = True
    self._ParseOrMerge(lines, message)
    return message

  def _ParseOrMerge(self, lines, message):
    """Converts a text representation of a protos message into a message.
  ...
  def _MergeField(self, tokenizer, message):
    """Merges a single protos message field into a message.

    Args:
      tokenizer: A tokenizer to parse the field name and values.
      message: A protos message to record the data.
...
class Tokenizer(object):
  ...
  It was directly ported from the Java protos buffer API.
  """
  ...
  def ConsumeIdentifier(self):
    """Consumes protos message field identifier.
