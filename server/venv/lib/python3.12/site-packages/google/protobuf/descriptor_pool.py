...
a collection of protos buffer descriptors for use when dynamically creating
message types at runtime.

For most applications protos buffers should be used via modules generated by
the protos buffer compiler tool. This should only be used when the type of
protos buffers used in an application or library cannot be predetermined.
...
module in order to create a protos buffer class that can be encoded and
decoded.
