...
"""Contains container classes to represent different protos buffer types.

This file defines container classes which represent categories of protos
  ...
  def __init__(self, message_listener: Any, message_descriptor: Any) -> None:
    ...
    Args:
      message_listener: A MessageListener implementation.
        ...
        Modified() method when it is modified.
      message_descriptor: A Descriptor instance describing the protos type
