...
"""Contains an abstract base class for protos messages."""
...
class Message(object):
  ...
  """Abstract base class for protos messages.

  Protocol message classes are almost always generated by the protos
  ...
  def MergeFromString(self, serialized):
    """Merges serialized protos buffer data into this message.
  ...
  def ParseFromString(self, serialized):
    """Parse serialized protos buffer data in binary form into this message.
  ...
  def SerializeToString(self, **kwargs):
    """Serializes the protos message to a binary string.
  ...
  def _SetListener(self, message_listener):
    """Internal method used by the protos message implementation.
