...
class ProtocolReceiver(abc.ABC):
    """A means of receiving protos values during an operation."""

    @abc.abstractmethod
    def context(self, protocol_context):
        """Accepts the protos context object for the operation.

        Args:
          protocol_context: The protos context object for the operation.
        """
        raise NotImplementedError()
...
class Subscription(abc.ABC):
    ...
    Attributes:
      ...
      protocol_receiver: A ProtocolReceiver to be passed protos objects as they
